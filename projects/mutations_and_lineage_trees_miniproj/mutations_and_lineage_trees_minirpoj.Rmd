...
get_clone_region <- function(clone_num,db,seq_col="SEQUENCE",junc_len_col="JUNCTION_LENGTH",clone_col="CLONE") {
...
observedMutations_L <- function(db,sequenceColumn = "SEQUENCE_IMGT", germlineColumn = "PARENT_SEQUENCE", clone_col="CLONE",
  ...
  for (cur_clone in clones_in_db) {
    ...
    clone_observeedMutations_db<-observedMutations(db=cur_clone_db,sequenceColumn = sequenceColumn,
                                                   germlineColumn =germlineColumn,regionDefinition=cur_clone_reg,
                                                   mutationDefinition=mutationDefinition,ambiguousMode=ambiguousMode,
                                                   frequency=frequency,combine=combine) 
