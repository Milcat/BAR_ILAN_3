...
make_graph_df <- function(cur_clone_graph,cur_clone_obj) {
  ...
  #4.Renaming SEQUENCE_ID column to ORIG_SEQUENCE_ID, and setting a new SEQUENCE_ID column with following format:  
...
```{r loop_on_clones}
#clones_to_build_trees<-c(2955,2003,4969)
first_clone<-TRUE
loop_start_time<-Sys.time()
#suppressWarnings("binding factor and character vector, coercing into character vector")
...
```{r fig.width = 15, fig.height=10, eval=F}
